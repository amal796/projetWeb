		...
		<div class="page-title">
			<div class="grid-row">
				...
				<nav class="bread-crumb">
					...
					<a href="contact-us.php">Reclamation</a>
				</nav>
				<!-- / bread crumb -->
			</div>
		</div>
					...
					<section>
						...
						<div class="widget-contact-form">
							...
							<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
								<input type="text" name="titre" id="titre"  size="40" placeholder="Titre du reclamation">
								<input type="text" name="nom" id="nom" size="40" placeholder="Votre Nom" >
								<input type="text" name="receive" id="receive" size="40" placeholder="Nom du recepteur"  >
								<textarea name="message" id="message" cols="40" rows="3" placeholder="Your Message" ></textarea>
								<input type="submit"  class="cws-button border-radius alt">
							</form>
							<!--/contact-form -->
						</div>
					</section>
