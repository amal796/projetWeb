...
if (
	...
	if (
		...
		echo '<script type="text/javascript">alert("Reponse correcte!");</script>';
		...
		<div class="page-title">
			<div class="grid-row">
				...
				<nav class="bread-crumb">
					...
					<a href="contact-us.php">Evaluation</a>
				</nav>
				<!-- / bread crumb -->
			</div>
		</div>
					...
					<section>
						...
						<div class="widget-contact-form">
							...
							<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
								<input type="text" value="Question du formulaire ici" size="40" disabled>
								<input type="text" name="answer" id="answer" size="40" placeholder="Votre Reponse" >
